...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      ...
      var handler = _this.events[eventName] || []; //if this.events[eventName] is undefined, handler is an empty array instead
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/Muiz/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
exports.Collection = void 0; // import { User, UserProps } from './User';
...
function () {
  ...
  Object.defineProperty(Model.prototype, "on", {
    get: function get() {
      //using get accessor, the delegated on(..) method in Eventing class is not invoke, but instead, only get a reference of the delegated method.
      return this.events.on;
    },
    enumerable: false,
    configurable: true
...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id; //const { id } = data; //es2015 destructured
...
var usersCol = new Collection_1.Collection('http://localhost:3000/users', function (json) {
  return User_1.User.buildUser(json);
});
usersCol.on('change', function () {
  var rootEl = document.getElementById('root');

  if (rootEl) {
    new UserList_1.UserList(rootEl, usersCol).render();
  }
});
usersCol.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"C:/Users/Muiz/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Muiz/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
